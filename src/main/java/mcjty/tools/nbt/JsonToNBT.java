...
public class JsonToNBT {
   ...
   private CompoundNBT OrigionalNBT = new CompoundNBT();

   public static CompoundNBT getTagFromJson(String jsonString) throws CommandSyntaxException {
      return getTagFromJson(jsonString,new CompoundNBT());
   }

   public static CompoundNBT getTagFromJson(String jsonString,CompoundNBT OrigionalNBT) throws CommandSyntaxException {
      return (new JsonToNBT(new StringReader(jsonString),OrigionalNBT)).readSingleStruct();
   }

   @VisibleForTesting
   CompoundNBT readSingleStruct() throws CommandSyntaxException {
      CompoundNBT compoundnbt = this.readStruct(this.OrigionalNBT);
   ...
   public JsonToNBT(StringReader readerIn) {
      this.OrigionalNBT = new CompoundNBT();
      this.reader = readerIn;
   }

   public JsonToNBT(StringReader readerIn, CompoundNBT OrigionalNBT) {
      this.OrigionalNBT = OrigionalNBT;
      this.reader = readerIn;
   }
   ...
   public CompoundNBT readStruct() throws CommandSyntaxException {
      return readStruct( new CompoundNBT());

   }
   public CompoundNBT readStruct(CompoundNBT OrigionalNBT) throws CommandSyntaxException {
      this.expect('{');
      CompoundNBT compoundnbt = OrigionalNBT;
      this.reader.skipWhitespace();
